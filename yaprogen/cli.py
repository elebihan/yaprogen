...
def main():
    ...
    p = subparsers.add_parser("list", help=_("list available templates"))
    p.add_argument(
        "kind",
        nargs="?",
    ...
    p = subparsers.add_parser("create", help=_("create a new project"))
    p.add_argument("-a", "--author", metavar=_("NAME"), help=_("set author name"))
    p.add_argument(
        "-c", "--copyright-holder", metavar=_("NAME"), help=_("set copyright holder")
    )
    p.add_argument("-C", "--company", metavar=_("NAME"), help=_("set company name"))
    p.add_argument(
        "-d",
        "--description",
        metavar=_("TEXT"),
    ...
    p.add_argument(
        "-e", "--email", metavar=_("ADDRESS"), help=_("set email address of the author")
    )
    p.add_argument(
        "-H", "--homepage", metavar=_("URL"), help=_("set URL of project homepage")
    )
    p.add_argument(
        "-l",
        "--license",
    ...
    p.add_argument(
        "-q", "--quiet", action="store_true", default=False, help=_("be quiet")
    )
    p.add_argument(
        "-s",
        "--spdx",
    ...
    p.add_argument("template", help=_("name of the template"))
    p.add_argument("project", help=_("name of the project"))
